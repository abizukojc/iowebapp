...
/**
 * Klasa która konwertuje dane z tabelki do formatu iCal i tworzy strumień
 * wejściowy.
 * 
...
class IcalGenerator implements StreamSource {
	...
	/**
	 * Tablica przechowująca referencje do wszystkich wydarzeń
	 * (CalendarEvent).
	 */
	private final BeanItemContainer<CalendarEvent> eventsContainer;

	/**
	 * Konstruktor przyjmujący eventsContainer.
	 * 
